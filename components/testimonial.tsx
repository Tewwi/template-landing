...
const Testimonial = () => {
  ...
  return (
    <div
      id="testimonials"
      className="w-full max-w-screen-md mx-auto pt-2 xs:pt-12 px-2"
    >
      <h2 className="mb-6 xs:mb-14 text-4xl md:text-5xl font-bold text-center tracking-tight">
        Team Members
      </h2>
...
const TestimonialCard = ({
  ...
  <div className="mb-8 bg-accent rounded-xl py-8 px-6 sm:py-6">
    <div className="flex items-center justify-between gap-20">
      <div className="hidden lg:block relative shrink-0 aspect-[3/4] max-w-[12rem] w-full bg-muted-foreground/20 rounded-xl">
        <Image
          src="/placeholder.svg"
          fill
          alt=""
